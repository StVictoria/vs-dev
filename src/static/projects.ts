...
export const projects: IProject[] = [
    ...
    { id: 6, title: 'Viktoriia | Frontend developer', img: portfolio, githubLink: '/', techs: [{ id: 1, title: 'React', icon: react, to: '/' }, { id: 2, title: 'SASS', icon: sass, to: '/' }, { id: 1, title: 'MUI', icon: mui, to: '/' }] },
]